...
int main(int argc, char** argv)
{
    ...
    catch (const AeroJet::Compiler::Exceptions::CompilerException& ex)
    {
        spdlog::error(ex.what());
        return ex.errorCode();
    }
    catch (const AeroJet::Exceptions::RuntimeException& ex)
    {
        spdlog::error(ex.what());
        return AeroJet::Compiler::ErrorCodes::EXIT_CODE_ERROR_UNKNOWN;
    }
    catch (...)
    {
        return AeroJet::Compiler::ErrorCodes::EXIT_CODE_ERROR_UNKNOWN;
